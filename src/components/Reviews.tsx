...
const reviews: Review[] = [
  {
    ...
    rating: 5,
    date: '2024-11-15',
    text: "The Darjeeling First Flush is extraordinary. I've tried many premium teas, but TeaHub's quality is unmatched. The muscatel notes are perfectly balanced, and the freshness is remarkable.",
  ...
  },
  {
    ...
    rating: 5,
    date: '2024-11-10',
    text: "Finally found a Masala Chai that tastes like my grandmother used to make! The spice blend is authentic and aromatic. This has become my daily morning ritual.",
    product: 'Masala Chai',
  },
  {
    id: '3',
    ...
    rating: 5,
    date: '2024-11-05',
    text: "TeaHub's Earl Grey Reserve is sophisticated and complex. The bergamot is perfectly infused without overpowering the tea. Exceptional packaging too!",
    product: 'Earl Grey Reserve',
  },
  {
    id: '4',
    name: 'Vikram Singh',
    ...
    rating: 5,
    date: '2024-10-28',
    text: "The Assam Gold has the perfect malty richness I've been searching for. Bold enough for my morning brew but smooth enough to enjoy without milk. Highly recommended!",
    product: 'Assam Gold',
  },
  {
    id: '5',
    ...
    rating: 5,
    date: '2024-10-20',
    text: "Switched to TeaHub's Organic Green tea and noticed a real difference in quality. Clean taste, no bitterness, and I love knowing it's sustainably sourced.",
    product: 'Organic Green',
  },
];
